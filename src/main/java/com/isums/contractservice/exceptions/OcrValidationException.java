...
public class OcrValidationException extends RuntimeException {
    ...
    public static final String CANNOT_READ_NAME = "OCR_CANNOT_READ_NAME";
    ...
    /** OCR back-end service unreachable / crashed / returned malformed data.
     *  Prior behavior was to log+swallow, which let unverified contracts
     *  proceed. Now we raise this so the tenant sees "retry later" instead. */
    public static final String OCR_SERVICE_UNAVAILABLE = "OCR_SERVICE_UNAVAILABLE";
}
